...
from mosfet import NanoMOSFETDesigner, load_and_preprocess_data, plot_training_history
...
class MOSFETDesignerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("NanoMOSFET Designer - GUI")
    ...
    def create_widgets(self):
        ...
        self.generate_btn = ctk.CTkButton(
            button_frame, text="Generate Synthetic Data",
        ...
        self.epochs_entry = ctk.CTkEntry(train_options_frame, placeholder_text="100", width=80)
        ...
        self.batch_entry = ctk.CTkEntry(train_options_frame, placeholder_text="64", width=80)
        ...
        results_label = ctk.CTkLabel(results_frame, text="Design Results", font=("Arial", 14, "bold"))
    ...
    def on_material_change(self, choice):
        ...
        try:
            self.designer = NanoMOSFETDesigner(material=choice)
    ...
    def generate_data(self):
        ...
        try:
            ...
            self.status_label.configure(text="Status: Generating data...", text_color="orange")
            self.root.update()

            material = self.material_var.get()
            self.designer = NanoMOSFETDesigner(material=material)

            X_train, y_train = self.designer.generate_synthetic_training_data(5000)
            ...
            self.results_text.insert("end",
                                     f"✓ Generated 5000 synthetic samples\n"
